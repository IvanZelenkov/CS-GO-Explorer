...
public class Launcher {
    public static void main(String[] args) throws Exception {
        ...
        final String usage = "\n" +
                "Usage:\n" +
                "    java -jar <accessKey> <secretAccessKey> <adminName> <roleName> <trustPolicyFileLocation> <permissionsPolicyName> " +
        ...
        // 10 sec delay avoids race condition between IAM and Lambda
        Thread.sleep(10000);
