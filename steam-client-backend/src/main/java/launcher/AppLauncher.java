...
/**
 * Launches Steam Client application to the user's AWS account using a single command.
...
public class AppLauncher {
    public static void main(String[] args) throws Exception {
        ...
        final String roleName = "SteamClientRole"; // IAM
        final String permissionsPolicyName = "SteamClientFullAccess"; // IAM
        final String restApiName = "steam-client-rest-api"; // API Gateway
        final String s3BucketName = "steam-client-dynamo-db-table-actions"; // S3
        final String snsTopicName = "SteamClientDynamoDBTableActions"; // SNS
        final String lambdaFunctionName = "steam-client-lambda"; // Lambda
        final String botName = "SteamClientBot"; // Lex
        final String tableName = "SteamClientTable"; // DynamoDB
        final String codeCommitRepositoryName = "SteamClientRepository"; // CodeCommit
        final String appName = "SteamClient"; // Amplify
        ...
        String lexRoleArn = IAM.createServiceLinkedRole(iamClient, "lexv2.amazonaws.com", Lex.lexRoleCustomSuffixGenerator(), "Steam Client Lex V2 bot role");

        // Create an IAM Lambda role and attach trust policy
        String roleArn = IAM.createRole(iamClient, roleName, "Steam Client Trust Policy");
        ...
        // Create REST API
        String restApiId = ApiGateway.createAPI(apiGatewayClient, restApiName, "REST API for Steam Client application",
        ...
        String cloneUrlHttp = CodeCommit.createRepository(codeCommitClient, codeCommitRepositoryName, "UI of the Steam Client application");
        ...
        String appId = Amplify.createApp(amplifyClient, appName, "Steam client application", Platform.WEB, roleArn,
        ...
        String lambdaArn = Lambda.createLambdaFunction(lambdaClient, lambdaFunctionName, "Steam Client application logic",
...
//        ApiGateway.createApiKey(apiGatewayClient, "DBM_key", "Test key", true, usagePlanId, "API_KEY");
        ...
        System.out.println("Steam Client will be available at https://main." + appDefaultDomain
